...
▶️ _It only takes about 5 minutes to get up and running with ArchiveBox._

ArchiveBox [officially supports](Install.md#supported-systems) **macOS**, **Ubuntu/Debian**, and **BSD**, but likely runs on many other systems. You can run it on any system that supports **Docker** and/or Python. Windows _is not supported_ unless you run it inside Docker Desktop, Docker in WSL2, or WSL2.
